...
class Navigation {
  ...
  static Future<dynamic> navigateClean(Widget page) async =>
  ...
  static void navigateBack([Object? result]) {
    if (hasBack()) {
  ...
  static Future<dynamic> navigateReplace(Widget page) async => navigatorKey
      .currentState
